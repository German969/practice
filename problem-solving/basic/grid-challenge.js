...
function gridChallenge(grid) {
  ...
  //        newGrid[index] = (newGrid[index] || '') + char;
  //     })
  // });
  // console.log(newGrid);
  // console.log(newGrid.map(row => row.split('').sort().join('')));
  // const ordered = newGrid.every(row => row == row.split('').sort().join(''))
  // return ordered ? 'YES' : 'NO'
}
